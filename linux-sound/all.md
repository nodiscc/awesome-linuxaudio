...
* [Cecilia Tutorials](http://music.ucdavis.edu/re4m/cecilia/tutor.htm) great stuff from **UC Davis** (not to be confused with Ossie Davis) 
* **Ceres**
...
* I've heard that **Finale** will run under this one. Does anyone have any other reports ? 
...
* [jack_convolve](http://www.affenbande.org/~tapas/wiki/index.php?jack_convolve) "... a simple convolution engine for **jackd** ", from Florian Schmidt 
...
* [jack_fst](http://linuxaudiosystems.com/fst/) a **JACK** client for running **VST/VSTi** plugins 
* [JACK](http://jackaudio.org/) Paul Davis's professional-quality low-latency audio server and transport control interface 
* [JACK](http://jackit.sourceforge.net/) Paul Davis's professional-quality low-latency audio server and transport control interface 
...
* [JackLab](http://jacklab.net/) an **openSuSE** media-optimized Linux distribution 
...
* [JackMix](http://roederberg.dyndns.org/~arnold/jackmix/index) a master mixer for connected **JACK** apps, from Arnold Krille 
* [JackMix](http://www.arnoldarts.de/drupal/?q=JackMix:intro) a master mixer for connected **JACK** apps, from Arnold Krille 
* [jacko](http://members.iinet.net.au/~lawrieabbott/pub/) a nice **wxPython** GUI for controlling **JACK**
* [jackOrgan](ftp://ftp.suse.com/pub/people/mana) an **ALSA** sequencer/ **JACK** client for David Bartold's **LADSPA** plugin 
* [jack.osc/midi.osc](http://www.alphalink.com.au/~rd/) daemons for publishing JACK transport control and MIDI packets over a UDP network connection, from Rohan Drapes 
* [jack_oscrolloscope](http://das.nasophon.de/jack_oscrolloscope/) realtime waveform viewer from Dominic Sacre
* [jack.plumbing](http://www.alphalink.com.au/~rd) a **JACK** connection daemon, also from Rohan Drapes 
* [JACK Rack](http://jack-rack.sourceforge.net/) excellent utility for creating racks of **LADSPA** plugins 
* [JACK Rack](http://pkl.net/~node/software/) another fine utility from Bob Ham 
* [jack_snapshot](http://www.affenbande.org/~tapas/wiki/index.php?jack_snapshot) a command-line based utility to store/restore JACK connection states, from Florian Schmidt 
...
* [JARS Music/Sound](http://www.jars.com/classes/jresout.cgi?category=Multimedia+-+Music/Sound&language=Java&rating=All) a large list of applets and applications from the [JARS](http://www.jars.com/) Automatic Resource Listing 
...
* [Java Sound API](http://www.javasoft.com/products/java-media/sound/index.html) useful information from **Sun Microsystems**
* [Java Sound for Linux Netscape](http://www.alumni.caltech.edu/~dairiki/libmmoss/README.html) making it work... 
...
* [JCself](http://www.peter-heeren.de/jcself/man.htm) generates orc/sco files for **Csound**
* [jcsound](http://cs-wrappers.sourceforge.net/) a **JACK** wrapper for **Csound** , from Gerard van Dongen 
* [jcsound](http://cs-wrappers.sourceforge.net/) A JACK wrapper for Csound, from Gerard van Dongen. 
* [jdelay](http://users.skynet.be/solaris/linuxaudio/) tests soundcard latency, requires **JACK**
...
* Jesus Villena's [Convert 1.4](http://www.th-zwickau.de/%7emaz/convert.html) is an excellent format conversion utility especially good for working with various commercial sampler formats (e.g., Ensoniq ASR, Yamaha TX16W, Kurzweil K2000, etc.) 
...
* [JVOIPLIB](http://lumumba.luc.ac.be/jori/jvoiplib/jvoiplib.html) **Jori's Voice over IP Library** is an object-oriented VoIP library written in C++ 
...
* [KhordPro](http://digilander.iol.it/merlim/khordpro/) very nice **ChordPro** viewer for **KDE**
...
* [kluppe](http://dieb13.klingt.org/content/projects/kluppe.html) "... a **JACK** -ified GTK-based loop player for files and live-input", from d13b 
...
* [KPhone](http://www.wirlab.net/kphone/index.html) "... is a SIP user agent for Linux, with which you can initiate VoIP connections over the Internet" 
...
* [KSidplay](ftp://ftp.kde.org/pub/kde/unstable/apps/multimedia/sound) **KDE** front-end for **SIDPLAY**
* [KSoundRecord](http://www.imn.htwk-leipzig.de/~mzander//KDE/ksoundrecord/) **KDE** utility from Mathias Zander 
* [Kticker](http://www.duskglow.com/personal/software.shtml) nice metronome for **KDE 3.1**
...
* [Lack Of Invention](http://ava.wz.cz/loi.html) a realtime signal processor based on **LADSPA** plugins 
* [Lack Of Invention](http://ava.wz.cz/loi.html) realtime signal processing based on **LADSPA** plugins 
* [LADCCA](http://pkl.net/~node/ladcca.html) introducing the **Linux Audio Developer's Configuration and Connection API** , "... a session management system for **JACK** and **ALSA** audio applications on GNU/Linux." 
...
* [LADSPA Plugins](http://users.skynet.be/solaris/linuxaudio/) Moog filter, chorus, reverb, and more from Fons Adriaensen 
...
[LAM](http://lam.fugal.net), the wonderful Linux Audio Music site. If you'd
...
* [LCP Perl](http://www.dmriley.demon.co.uk/code/lcp-perl/) from David Riley, scripts for controlling **LADSPA** plugins via text-mode or graphic interfaces 
* [LDAS](http://www.q2s.ntnu.no/~asbjs/ldas/ldas-0.1.1.tar) the Low Delay Audio Streamer, software from Asbjørn Saebø
* [LDrum](http://www.sinussource.de/ldrum/) cool new drum machine/rhythm programmer from Peter Eschler 
...
* [libfst](http://linuxaudiosystems.com/fst/) in-process **VST/VSTi** support from Torben Hohn and Paul Davis 
...
like to hear what can be done with Linux sound and music software, the LAM
...
* [linart](http://linart.net/) is Michael Stutz's discussion group concerned with Linux and artistic issues 
![](line.gif)
* [linphone](http://simon.morlat.free.fr/english/index.html) more VoIP for Linux, from Simon Morlat 
...
* [Linux Audio Blog](http://linuxaudioblog.jawebada.de/)
* [Linux Audio Blog](http://linuxaudioblog.jawebada.de) "collected news, musings, ramblings with regard to Linux audio" 
...
* [Linux Audio Developers](http://www.linuxdj.com/audio/lad) the LAD list is dedicated to "discussion of topics relevant to audio under Linux, with an accent on development issues" 
...
* [Linux Audio Live CD](ftp://ftp.suse.com/pub/suse/i386/live-cd-9.2/) published by the German magazine [Keyboards](http://www.keyboards.de), now freely available on-line 
...
* [Linux Audio Users](http://www.linuxdj.com/audio/lad/subscribelau.php3) a mail-list for people focused on using rather than hacking Linux audio applications 
...
* [Linux Game Development Center](http://sunsite.dk/lgdc/) excellent resource center for Linux game developers 
* [Linux Games](http://www.linuxgames.com/) the other major listing of games for the Penguin People...  _Note:_ _As of June 2002 I am no longer listing Linux games. Please see the links above for complete up-to-date catalogs of games for Linux._
...
* [Linux Laptop Sound Configuration](http://linux.oreillynet.com/pub/a/linux/2002/09/19/linuxlaptop.html) an **O'ReillyNet** article describing sound setup for an HP Omnibook 4150 
![](linux.logo.1b.gif)
...
* [Linux Multimedia Homepage](http://m4l.berlios.de/cgi-bin/bin/view/Main/WebHome) "All about Sound, TV, Video, DVD with Linux", an excellent site from Holger Klemm ( _This site is in German._ ) 
...
* [Linux Music Apps CD](http://mstation.org/appsCD.html) a great collection from John Littler 
* [linuxmusician.com](http://www.linuxmusician.com/) a new community site from the **Rosegarden** team, for users of any & all Linux music software 
* [Linux Music Station](http://www.Mstation.org) dedicated to Linux music matters 
...
* [Linux Realtime Effect Processor](http://www.blendinpulse.fr.st/linux/) a **LADSPA** -based fx, aimed at embedded systems (i.e., no GUI) 
...
* [Linux Telephony](http://www.linuxtelephony.org/) "bridging the Linux and telephony paths..." 
...
* [Listening Comparisons For Audio Codecs At 64kbps](http://audio.ciara.us/test/64test/results.html) interesting results from an on-line public test from [Hydrogen Audio](http://www.hydrogenaudio.org/)
...
* [LMMS](http://lmms.sourceforge.net/) it's the Linux MultiMedia Studio, "... a free alternative to popular programs like **FruityLoops** , **Cubase** and 
* [LMMS](http://lmms.sourceforge.net/) it's the Linux MultiMedia Studio, "... a free alternative to popular programs like **FruityLoops** , **Cubase** and * [Loki Games](http://www.lokigames.com/) "...dedicated to bringing best selling computer games to Linux" 
...
* [Loop](http://www.gnugeneration.com/software/loop/loop.html) a great demo from **CSR**
* **Looping CD Players**
Looping Software
...
* [Low-latency RPMs](ftp://ftp.udoj.org/linux/RPMS/kernels/LowLatency/) packages from Udo Jocher that include a 2.4.18 kernel patched for low-latency and preemptive operation 
...
* [Lyric Display System](http://www.adebenham.com/lds/) an application "...to edit/display lyrics on a second screen/projector for use at singing events such as church services", from Chris Debenham 
...
* [Medialinux at OSL](ftp://logx.it/mirrors/medialinux/) a **Knoppix** -based Linux distribution focused on multimedia 
...
* [MESS](http://www.muse-sequencer.org/wiki/index.php/Tour#Create_your_own_softsynth_with_M.E.S.S) Werner Schweer's [MusE](http://www.muse-sequencer.org) Experimental SoftSynth API, designed for easily building custom softsynths. Note that MESS also enables VST support within MusE. 
...
* [MicroMod](http://website.lineone.net/~martin.cameron) good player from Martin Cameron, requires **Java**
...
MIDI-related programming tools._
...
* **MikMod**
* [MikMod for Java](http://t2.technion.ac.il/~shlomif/jmikmod/) is now available from Shlomi Fish 
* [MikMod](http://mikmod.raphnet.net/) classic MOD player for Linux with curses or **X** interface 
* [MikMod](http://mikmod.raphnet.net/) classic MOD player for Linux with curses or **X** interface ( _Be sure to check out_ [this page](http://www.freenet.tlh.fl.us/~amstpi/mikmod.html) _as well !_ ) 
...
### Mixers
* **Mixers:**
Mixers | MOD Trackers/Players | MPEG Players/Encoders | Musicians Utilities
...
* [MMA](http://users.xplornet.com/~bvdp/mma) Bob van der Poel's neat MIDI music accompaniment generator 
...
* [MODPlug Player](http://www.modplug.com/index.php3) popular MOD player now for Linux's own **XMMS**
* [modplugplay](http://gnu.ethz.ch/linuks.mine.nu/modplugplay/) command-line module player, supports many module types 
* [modplugplay](http://www.linuks.mine.nu/modplugplay/) command-line module player, supports many module types 
### MOD Trackers/Players & Other Resources
* **MOD Trackers/Players & Other Resources:**
...
* [Module Building In Cecilia](http://www.findarticles.com/p/articles/mi_m0FGL/is_11_19/ai_108258027) Bill Beck reveals the secrets in **Electronic Musician**
...
* **M/pc** (a beautiful port of [M 2.0](http://mars.let.uva.nl/ACCA/ACCA.ToolsList.html)), also from Voyetra 
...
* **MPEG Players & Encoders:** **Note:** _As of May 2002 I will no longer list many new MP3 applications. Please see the listings on[Freshmeat](http://freshmeat.net) and [Linux.MP3 Tools](http://linuxmp3.free.fr/) for more up-to-date catalogs of players and other MP3 software._ MPEG Players & Encoders
...
Multitrack Recording and Mixing Systems
multitrack recording capabilities._
...
* [MU.SE.S](http://www.luiginegrettilanner.com/muses.htm) software for transforming musical series, requires **Csound** and **FLTK**
* [Museum Sound Powered By Linux](http://www.linuxdesktop.it/benno/southtyrolgame/) notes on a project from Benno Senoner 
* [MusE Wiki](http://lmuse.sourceforge.net/wiki/index.php/Main_Page)
...
* [MusicBox](ftp://mustec.bgsu.edu/pub/linux/mbox.tar.gz) and other algorithmic MIDI programs from [John Dunn](http://algoart.com/)
...
Music Made With Linux
Music Made With Linux Be sure to check out Hans Fugal's
...
* [Musix GNU+Linux](http://www.musix.org.ar) a "live" music & sound distro from Marcos Guglielmetti and friends 
* [Musix GNU+Linux](http://www.musix.org.ar) new release 0.39 now available 
...
* [Nama](http://freeshell.de/~bolangi/cgi1/nama.cgi/00home.html) Multitrack recording, mixing and mastering application by Joel Roth. Uses console or minimal GUI. 
...
Nevertheless, all of these emulators open Linux to even more useful software,
New Additions
...
* [nGen](http://mustec.bgsu.edu/~mkuehn/ngen/) Mikel Kuehn's generator for Csound scoes and Standard MIDI files 
...
* [NJL Plugins](http://www.ecs.soton.ac.uk/~njl98r/code/ladspa/njl-plugins/) **LADSPA** goodness from Nick Lamb 
...
**Note:** _As of May 2002 I will no longer list many new MP3 applications.
...
* [Open Beat Box](http://openbeatbox.org/) unique drum machine, requires **PyQt**
...
* [openphone.org](http://www.openphone.org/) "...dedicated to the development of high-quality, low-density Internet telephony solutions..." 
...
* **Organ Synths**
* [Oscilloscope](http://ll-plugins.sf.net) scope plugin with two channels, controllable trigger, time resolution, separate amplification and DC offset for both channels 
...
Other Neat Sound Stuff Players & Recorders | CD Software | Demos | Digital DJ
* **Other Neat Things**
...
* [PatchWork for Windows](ftp://ftp.maths.bath.ac.uk/pub/dream/platforms/pc/utilities/patchwork/) GUI for Csound instrument design 
...
* **PCMCIA Audio/MIDI**
* [pcmusic](ftp://wendy.ucsd.edu/pub/pcmusic/) is the DOS version of the software sound synthesis language **_cmusic_**
* **PC Speaker**
...
* [Planet CCRMA At Home](http://www-ccrma.stanford.edu/planetccrma/software/) RPM packages of the Linux sound and music software used at [CCRMA](http://www-ccrma.stanford.edu), thanks to Fernando Pablo Lopez-Lezcano 
...
* [Pmask](http://web.tiscalinet.it/mupuxeddu/csound/index.html) an implementation of **Cmask** in **Python** from Maurizio Umberto Puxeddu 
...
* [pmc](ftp://mustec.bgsu.edu/pub/linux/pmc-1.0.tar.gz) is Steve Falco's _polyrhythmic music compiler_ , which creates arbitrarily complex scores in Standard MIDI File and **KeyKit** formats, and Steve's [pmc_music](ftp://mustec.bgsu.edu/pub/linux/pmc_music.tar.gz) is a collection of scores for the compiler. 
...
* [Printable Manuscript Paper](http://www.lib.virginia.edu/dmmc/Music/Musicpaper/) useful music stuff in PostScript and PDF formats 
...
* Programs running under [Basilisk II](http://www.uni-mainz.de/~bauec002/B2Main.html), a **Macintosh 68K** emulator which supports sound 
...
* Programs running under [UAE](http://www.freiburg.linux.de/~uae/), an **Amiga** emulator for UNIX, with support for full stereo sound (4 x 8bit channels) 
...
* [PVTool](http://www.muse.demon.co.uk/csound.html) manipulates Csound phase vocoder files 
...
* [Pymprovisator](http://pymprovisator.sourceforge.net) **Python** -based program for accompaniment and improvisation assistance, from David Asorey Álvarez 
...
* [q2ladspa](ftp://mustec.bgsu.edu/pub/linux/q2ladspa.tar.gz) partial implementation of a set of plugins based on **Quasimodo**
...
* [QARecord](http://www.suse.de/~mana/kalsatools.html) "... simple multithreaded stereo recording tool" from Dr. Matthias Nagorni 
...
* [Qrash](http://qmg.org/files/demos/qmg/) another cool demo for Linux 
...
* [Rasca](http://www.penultima.org/~rasca/) an audiofile player for MPEG2, MP3, and WAV formats 
...
* [RD JACK Apps](http://www.alphalink.com.au/~rd/) useful **JACK** applications from Rohan Drape 
...
* [remix.linux](http://remix.machinehasnoagenda.com/media/register) "a place for subscribers of the Linux Audio Users list to share/remix/extend/master each others work, with the freedoms offered by Creative Commons licenses" 
...
* **Rio Utilities**
* **Rippers**
* [ripperX](http://ripperx.sourceforge.net/) GUI to **cdparanoia** and other rip/encode utilities 
...
* [Rivendell](http://www.salemradiolabs.com/rivendell/) beta release of "... a complete radio broadcast automation solution", from Fred Gleason and **Salem Radio Labs**
...
* [Robust Audio Tool](http://www-mice.cs.ucl.ac.uk/multimedia/software/rat/index.html) open-source streaming audio and conferencing 
...
* [Rosegarden Developers Interview](http://www.linuxdevcenter.com/pub/a/linux/2004/12/16/rosegarden.html) Howard Wen chats with the minds behind the software 
...
* [Rytmo](http://www.acooke.org/jara/rytmo/index.html) rhythm pattern generator for **Csound**
* [S3MOD](ftp://sunsite.unc.edu/pub/Linux/apps/sound/players/) MOD/S3M module player 
* [S3MOD](http://www.chat.net/~jeske/s3mod.html) MOD/S3M module player 
* [Sabre Flight Simulator](http://www.panteltje.demon.nl/sabre_sound/) now has a Linux sound server 
* [Sakura Player](http://darkstar.tabu.uni-bonn.de/~neo/tfmx.html) a Linux player for the **TFMX** music format 
* **SAM9407**
...
* [Sarah Tracker](http://www.pyro.net/~crayc/sarah/) a new tracker in development 
...
* [Scene.org](http://www.scene.org) best general info/ftp site for the demo scene 
...
* [Score11](http://ecmc.rochester.edu/ecmc/docs/allan.cs/score11.info.html) A Csound score file preprocessor from Allan Schindler and the [Eastman Computer Music Center](http://www.esm.rochester.edu). 
* [score](ftp://mustec.bgsu.edu/pub/linux/) Troy Henderson's utility to print PostScript-printable music manuscript paper 
...
* [Scripts: Sound](http://www.wordecho.com/code/code.html) for **Csound** , **PowerPV** , and **TrikTraks** , from Drew Krause 
...
* [SDL](http://www.libsdl.org/index.php) Simple DirectMedia Layer, an excellent multimedia library development project 
...
_See also_[4Front](drivers.html) _and_ [Software Synthesis](swss.html) Linux
_See also_[Rosegarden](notation.html) _for an excellent notation-based
...
* [Sineshaper](http://ll-plugins.sf.net) a monophonic **DSSI** synthesizer from Lars Luthman 
...
site delivers the audible goods. Podcast and M3U streams are available. Tune
...
* [Solfege](http://www.solfege.org) ear training program with **Gtk** interface 
...
* [Songforge](http://the-fix.org/songforge/) "...a means of making music in an open source environment.... allows users to upload and download audio files (MP3/OGG), add their own instrumentation to the tracks or remix the tracks, then upload the new file as a 'child' song of the original..." 
...
* [SongWrite](http://oomadness.tuxfamily.org/en/songwrite/) the latest and greatest incarnation of what was formerly Jiba's **GTablature**
...
* [SooperLooper](http://essej.net/sooperlooper/) excellent looping sampler **LADSPA** plugin from Jesse Chappell 
...
### Sound Cards & Drivers
Sound Cards & Drivers
* [Sound Card Support for Linux with Laptops](http://mobilix.org/sound_linux.html) a survey from Werner Heuser 
...
Soundfile Editors & Utilities
* Soundfonts 
* [Sound Forge XP](http://www.sfoundry.com/) (4)  
...
* [Sound Object Library](http://www.may.ie/academic/music/musictec/mt_software.shtml) "a set of object-oriented cross-platform audio development tools and sample programs...for the quick design of sound processing applications" 
* [Sound On Sound Linux Forum](http://sound-on-sound2.infopop.net/2/OpenTopic)
sound.org)
* [SoundPanel](http://www.salemradiolabs.com/) "an application for the organization and playout of audio cuts...for use in busy broadcast and live performance environments" 
...
* [Sound Sculptor II](http://members.aol.com/sculptorii/index.html) a very nice soundfile editor 
...
* [Soundtank](http://www.nymu.net/soundtank) Jacob Robbins' **LADSPA** host designed for making and playing softsynths 
...
* [SpkrPhone](http://people.ne.mediaone.net/insouciant/spkrphone/index.html) enables use of a **USR Sportster** modem as a speaker phone 
...
* [State of Mind](http://skal.planet-d.net/mind/index.html) the other of the two best demos for Linux 
...
* [StompBoxes](http://mrbook.org/stompboxes/) guitar fx processor with **Gtk** interface 
...
* [Studio To Go!](http://www.ferventsoftware.com) a commercially available Linux distribution optimized for audio work and including a large selection of some of the best current Linux sound and music software, from the guys at **Fervent Software** , aka the **Rosegarden** gang 
...
* [Synaesthesia](http://yoyo.cc.monash.edu.au/~pfh/synaesthesia.html) is a lightshow calculated from FFT and stereo positioning information 
...
* [Temperaments](http://galifrey.triode.net.au/Music/Theory/temperaments.html) generates scales in user-selected temperaments ( _requires_ **Java** ) 
* [Tempered Notation](http://www.tekproject.com/music/) "A suggested scheme for the notation of tempered scales", from Carl Adams 
...
* [The Linux Game Tome](http://www.happypenguin.org/) the major listing of games for the Penguin People... 
...
* the MIDI programming environment [RAVEL](ftp://ftp.cs.pdx.edu/pub/music/ravel/) by [Jim Binkley](http://www.cse.ogi.edu/~jrb/)
* [The MOD Archive](http://modarchive.org) a large collection of MOD music 
* [The MOD Archive](http://www.modarchive.com/) a large collection of MOD music 
...
* [The teK Project](http://www.tekproject.com/) "A project to design, manufacture, and market a Tempering Enharmonic Keyboard", from Carl Adams 
...
* The [WINE Applications Support](http://www.winehq.com/apps.cgi) page rates an application's success on a scale from 0 to 5, with a higher number indicating greater viability. On March 25 1998 the page listed the following sound and MIDI applications and their ratings: 
...
* [thud](http://www.div8.net/thud/index.html) "the poor man/s drum machine", for **KDE** and **Qt**
...
* [Tim's Atari MIDI World](http://tamw.atari-users.net/steem.htm) large collection of excellent Atari MIDI software, most of which runs well under **Xsteem** (the Linux version of STEEM) 
...
* [TinySID](http://www.rbi.informatik.uni-frankfurt.de/~sinsch/TinySid.htm) "The world's smallest SID player", from the great Giant Sisters 
...
* [Tk-score](http://www.sci.fi/~mjkoskin/) a graphic utility for combining soundfiles and/or Csound scores into a single mega-score 
...
* [tocmake](http://tarp.worldserve.net/software/) PERL script for generating a table of contents for _cdrdao_
...
* [ToneFree](http://sourceforge.net/projects/tonefree/) utilities for controlling [Line 6](http://www.line6.com/main/main.cfm) guitar amplifiers and preamps via /dev/midi 
...
* **Tools & SDK Packages**
### Tools To Make Tools...
Tools To Make Tools... _Note:_ _See also the **MIDI Software** section for
* [TooSkini](http://silvertone.princeton.edu/winham/PPSK/TooSkini.html) _Minc_ for Perry Cook's [SKINI](http://www.cs.princeton.edu/~prc/NewWork.html) protocol for **Cmix**
...
* [tplay](http://www.iki.fi/ik/tplay.html) threaded and buffering audio player (RIFF/WAV, AU, raw PCM) 
* **Trackers**
...
* [Tunings & Temperaments](http://pages.globetrotter.net/roule/accord.htm) demonstrates tunings and temperaments ( _requires_ **Java** ) 
* [Turn-Key Linux Audio](http://lulu.esm.rochester.edu/kevine/turnkey/) a new Linux audio distro from Kevin Ernste at the **Eastman Computer Music Center**
...
* [Tux Games](http://www.tuxgames.com/) your 1-stop on-line shopping center for Linux games  _Note:_ _Although the Web site is still on-line Loki Games is no longer in business._
...
* [UADE](http://ee.tut.fi/~heikki/uade.html) is the "Unix Amiga Delitracker Emulator" (it does more than just play MODs!) 
...
* [Ultra Power Effects Max II](http://sed.free.fr/effects/) a realtime processor for full-duplex soundcards 
...
* [unix scene](http://unixscene.kameli.net/) excellent site for Linux demos and intros 
* [unumx](http://pages.cthome.net/chrismp/unumx/) extracts the MOD music files from the **Unreal Tournament** game 
...
very much in development and cannot yet be considered a stable environment.
...
* [ViaGratt](http://www.epita.fr/~bempel_j/ViaGratt/) guitar fx rack simulator 
...
* [Vmusic](http://users.xplornet.com/~bvdp/vmusic) good CD database software from Bob van der Poel, requires **Python** and **Tkinter**
...
* [VSTserver](http://www.notam02.no/arkiv/src/) Kjetil Matheussen's remarkable server for running **VST** plugins under Linux, FreeBSD, i386 Solaris, and others (requires **WINE** ); this site also serves up Kjetil's **vsti** dedicated VSTi server, the **LADSPA/VST** host, and his **k_vst~** object for **Pd**
...
* [VST/VSTi Plugins For Linux Database](http://ladspavst.linuxaudio.org) A community service project from Tim Orford. 
* [vu](http://tobiah.org/pub) a very useful command-line VU-meter from Toby Shepard 
...
* [WASP](http://artemiolabs.com/software/wasp/) the WAve Sculpting Plugins from Artemiy I. Pavlov 
...
* [WhySynth](http://home.jps.net/~musound/whysynth.html) more **DSSI** synth plugin excellence from Sean Bolton 
...
WINE, but I have been unable to confirm that report. Please note that WINE is
...
* [Wired](http://wired.epitech.net/) audio/MIDI music production system, from Colin Laplace and crew 
...
* [XAnim](http://smurfland.cit.buffalo.edu/xanim/home.html) the venerable **xanim** plays a wide variety of sound & video formats 
...
* [xine](http://xinehq.de) a most excellent multiformat audio/video player  
* [xjadeo](http://sourceforge.net/projects/xjadeo/) limited but interesting video player that displays the video frame corresponding to the **JACK** timebase 
...
* [xmradio](http://core.de/~coto/projects/xmradio/) **Motif** -based radio tuner, uses **Video4Linux** 
* [XmToMID](http://petra.hos.u-szeged.hu/~kokai/) converts XM tracker files to MIDI files 
...
* [XStick](http://xstick.sourceforge.net/) "...a tool for viewing scales, notes, and chords on the **Chapman Stick(R)** ", from Stew Benedict 
...
* [xtune](http://console-newsletter.hypermart.net/xtune/xtune.htm) nice simple guitar tuner 
